...
export default async function SlipGajiPrintPage({
  ...
  return (
    <>
      ...
      {/* Konten slip — yang ini yang terprint */}
      <div className="p-8 max-w-2xl mx-auto bg-white text-foreground min-h-screen print:p-6">
        ...
        {/* Gaji bersih — satu-satunya elemen yang ditonjolkan */}
        ...
        <div className="grid grid-cols-2 gap-8 text-center mb-6">
          <div>
            <p className="text-xs text-muted mb-12">Diterima oleh,</p>
            <p className="text-sm font-medium text-foreground border-t border-border-strong pt-2">
              {karyawan.nama}
            </p>
          </div>
          <div>
            <p className="text-xs text-muted mb-12">Disetujui oleh,</p>
            <p className="text-sm font-medium text-foreground border-t border-border-strong pt-2">
              HRD ABC Company
            </p>
          </div>
